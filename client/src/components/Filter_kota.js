...
export class Filter_kota extends Component {
	constructor(props) {
		super(props)
		this.state = {
			kota:'',
	...
	render() {
		return (				
			<div className="col-md-12">
				<h3><b>Filter Berdasarkan Kota</b></h3>	
				<div className="col-md-9">
					...
					<form 
						...
						<div className="form-group mr-sm-2">
							<label htmlFor="kota">Masukkan kota</label>
							<input
							id="kota"
							type="text"
					...
					<tbody>
						...
						{(this.props.sertifikats.filter(p => p.owner === this.props.account).length > 0)
							? this.props.sertifikats
								.filter(p => p.owner === this.props.account && p.kota === this.state.kota)
								.map((sertifikat, key) => {
								return (									
									<tr key={key}>
